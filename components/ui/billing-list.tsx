...
import { INR_RATE_LABEL } from '@/lib/currency';
...
export function BillingList() {
  ...
  return <section className="space-y-6" aria-labelledby="billing-title">
    <div><p className="text-sm font-medium text-[var(--indigo)]">Your account</p><h1 id="billing-title" className="mt-1 text-2xl sm:text-3xl font-bold">Billing & invoices</h1><p className="mt-2 text-sm text-[var(--grey)]">Review your monthly statements. Invoice totals are in USD. Open an invoice to preview, print, or save it as a PDF.</p><p className="mt-2 text-xs text-[var(--grey)]">{INR_RATE_LABEL}. A $100 invoice equals ₹8,500.</p></div>
