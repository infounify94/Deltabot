  ...
  try {
          ...
          <tbody className="text-sm">
            <tr className="border-b border-gray-200">
              ...
              <td className="py-4 text-right font-mono text-emerald-600">
                +{formatCurrency(Number(invoice.total_profit))}
              </td>
            </tr>
            {Number(invoice.previous_losses) > 0 && (
              <tr className="border-b border-gray-200 bg-gray-50">
                ...
                <td className="py-4 px-2 text-right font-mono text-red-600">
                  -{formatCurrency(Number(invoice.previous_losses))}
                </td>
              </tr>
            )}
            <tr className="border-b border-gray-200">
        ...
        <div className="flex justify-end mb-16">
          <div className="w-64 space-y-3">
            ...
            <div className="flex justify-between font-bold text-xl border-t-2 border-black pt-3">
              <span>Total Due</span>
              <span className="font-mono">{formatCurrency(Number(invoice.fee_amount))}</span>
            </div>
    ...
    return (
      <div className="p-10 font-sans text-red-600">
        <h1 className="text-2xl font-bold mb-4">Error Rendering Invoice</h1>
