    ...
    <div className="min-h-screen bg-[#050505] flex flex-col font-sans">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-[#0c101a] border border-white/10 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <p className="text-slate-400 text-center text-sm mb-8">Sign in or create a new ProfitPilot account</p>

          {error === 'auth-failed' && (
            <div className="bg-red-500/10 border border-red-500/20 text-red-400 text-sm p-4 rounded-lg mb-6 text-center">
          ...
          <div className="relative flex items-center justify-center mb-6">
            ...
            <div className="relative bg-[#0c101a] px-4">
          ...
          <button 
            ...
            className="w-full bg-white hover:bg-gray-100 text-black font-bold py-3 px-4 rounded-lg flex items-center justify-center gap-3 transition"
          >
